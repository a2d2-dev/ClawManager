...
func HandleError(c *gin.Context, err error) {
	...
	if strings.HasPrefix(errStr, "mode unavailable:") || strings.HasPrefix(errStr, "unsupported instance mode") || strings.HasPrefix(errStr, "unsupported runtime type") || strings.HasPrefix(errStr, "invalid instance mode/runtime_type combination:") || strings.HasPrefix(errStr, "invalid instance mode for instance_id=") {
		Error(c, http.StatusBadRequest, errStr)
		return
	}
